                ...
                <Col span={24}>
                    <Row className="div-flex">
                        <Col md={{span:12}} xs={{span:24}}>
                            <a className="foot-button" target='_blank' href='https://Twitter.com/etczunks'><FaTwitter size={24} className="footer-item"/></a>
                            <a className="foot-button" target='_blank' href='https://discord.gg/3aRMfdCq'><FaDiscord size={24} className="footer-item"/></a>
                            <a className="foot-button" target='_blank' href='https://t.co/l8N7bB5ZSg'><FaTelegramPlane size={24} className="footer-item"/></a>
                        </Col>
                        <Col md={{span:12}} xs={{span:24}} className="text-right">
                            <a className="foot-button" target='_blank' href='https://ethereumclassic.org/'>
                                ...
                                {/* <FaEthereum size={24} className=" text-right"/> */}
